...
--select * from fagsak where fk_person1_kravhaver = ; order by dato_utbet_fom;
,
siste as
(
  select *
...
--select * from siste where fk_person1_kravhaver = ;
,
...
--select * from opphor_hvis_finnes where fk_person1_kravhaver =  order by aar_maaned;
,
